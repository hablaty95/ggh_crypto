︠5b6b3fe5-79b5-4b66-953d-cee339a2d268o︠
# Másold ide a feladat szövegét
# Alapkövetelmény (30): Készíts implementációt a GGH sémához       (https://en.wikipedia.org/wiki/GGH_encryption_scheme)! 

# +10p: Készíts dokumentációt, ami bemutatja a programot és a módszert is (ami alapján pl. egy évfolyamtársad megértené a feladatot, a módszert és a megoldást)!

# +10p: Vizualizáld rácson a kulcsokat és a séma működését!
#...
from math import *
import random
class GGH:
